...
;$(document).on('click', '[data-color-toggle]', function(e){
	...
	$('[data-copy-link]').on('click touch', function() {
		var btn = $(this);
		Clipboard.copy(btn.attr('data-copy-link'));
...
function drawRadialIndicator(){
	...
	drawRound('roundCanvas2', scrollTop / (totalHeight - 100));
}
drawRadialIndicator();
...
$(document).ready(function() {
	...
	$('#spyFixed').find('.nav-item').each(function(i, a){
		var text = $(a).text();
