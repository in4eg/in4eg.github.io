...
a,!1)),u(a,a,"input",d.bound.update),u(a,a,"change",d.bound.update));d.bound.set_date(d.date,d.current)}d=a.__pickmeup.options;return{hide:d.bound.hide,show:d.bound.show,clear:d.bound.clear,update:d.bound.update,prev:d.bound.prev,next:d.bound.next,get_date:d.bound.get_date,set_date:d.bound.set_date,destroy:d.bound.destroy}}E.defaults={current:null,date:new Date,default_date:new Date,flat:!1,first_day:1,prev:"<i class='icon icon-arrow-left'></i>",next:"<i class='icon icon-arrow-right'></i>",mode:"single",select_year:!0,select_month:!0,select_day:!0,
view:"days",calendars:1,format:"d-m-Y",title_format:"B, Y",position:"bottom",class_name:"",separator:" - ",hide_on_select:!1,min:null,max:null,render:function(){},locale:"en",locales:{en:{days:"Воскресенье Понедельник Вторник Среда Четверг Пятница Суббота".split(" "),daysShort:"вс пн вт ср чт пт сб".split(" "),daysMin:"вс пн вт ср чт пт сб".split(" "),months:"Январь Февраль Март Апрель Май Июнь Июль Август Сентябрь Октябрь Ноябрь Декабрь".split(" "),monthsShort:"Янв Фев Март Апр Май Июнь Июль Авг Сент Окт Ноя Дек".split(" ")}},
...
b){var c=document.createElement("div");g(c,b);for(b=0;b<a.length;++b)g(a[b],"pmu-button"),c.appendChild(a[b]);return c}};return E});;(function(root, factory) {
    ...
    assign(SimpleLightbox.prototype, {
                        ...
                        '<div class="slbWrapOuter">' +
                            '<div class="slbWrap">' +
                                '<div class="slbContentOuter">' +
                                    ...
                                    '<button type="button" title="' + o.closeBtnCaption + '" class="slbCloseBtn ' + o.closeBtnClass + '"><i class="icon icon-close"></i></button>' +
                                    (this.items.length > 1
                                        ? '<div class="slbArrows">' +
        ...
        setupLightboxEvents: function() {
            ...
            this.addEvent(this.$el, 'click', function(e) {
                ...
                if (matches($target, '.slbCloseBtn, .icon-close') || (self.options.closeOnOverlayClick && matches($target, '.slbWrap'))) {
                    console.log('click');
                    self.close();
